...
<body>
    ...
    <div class="header">
        ...
        <h3>Riwayat Permintaan Barang - Laporan Komprehensif</h3>
                            ...
                            @foreach ($trx->items as $itemIndex => $item)
                                ...
                                <tr>
                                    @if ($itemIndex === 0)
                                        ...
                                        <td rowspan="{{ $trx->items->count() ?: 1 }}">{{ $trx->nama_peminta ?? '-' }}
                                        </td>
                                    @endif
    ...
    <div class="footer">
        Laporan Komprehensif Riwayat Permintaan Barang — Sistem Inventaris ATK Mahkamah Agung RI
    </div>
