...
<head>
    <meta charset="UTF-8">
    <title>Kartu Stok - Multiple Barang - {{ $month_name }} {{ $year }}</title>
    <style>
        @page {
            size: A4;
        ...
        * {
        ...
        .outer-wrap>tbody>tr>td.pad {
            width: 8%;
        }

        .outer-wrap>tbody>tr>td.content {
            width: 84%;
        }
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="content">
                            ...
                            <div class="info-block">
                                <table>
                                    <tr>
                                        <td>NAMA BARANG</td>
                                        <td class="colon">:</td>
                                        <td class="val">{{ strtoupper($data['barang']->nama) }}</td>
                                    </tr>
                                    <tr>
                                        <td>PERIODE</td>
                                        <td class="colon">:</td>
                            ...
                            <table class="main-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:7%;">{{ strtoupper($data['barang']->satuan) }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {{-- Baris Saldo Awal --}}
                                    <tr class="saldo-awal-row">
                                        ...
                                        <td class="center bold">{{ $data['saldo_awal'] }}</td>
                                        <td class="center"></td>
                                        <td class="center bold">{{ $data['saldo_awal'] }}</td>
                                        <td class="center"></td>
                                    </tr>

                                    @if (collect($data['rows'])->isEmpty())
                                        <tr>
                                            <td colspan="7" class="center"
                                                style="padding:12px; font-style:italic; color:#666;">
                                                Tidak ada transaksi pada {{ $month_name }} {{ $year }}
                                            </td>
                                        </tr>
                                    @else
                                        @foreach (collect($data['rows']) as $i => $row)
                                            <tr>
                                        ...
                                        @for ($e = 0; $e < max(3, 10 - collect($data['rows'])->count()); $e++)
                                            <tr class="empty-row">
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                    ...
                                    <tr class="total-row">
                                        ...
                                        <td class="center">{{ $data['saldo_awal'] + $data['total_masuk'] }}</td>
                                        <td class="center">{{ $data['total_keluar'] }}</td>
                                        <td class="center">{{ $data['saldo_akhir'] }}</td>
                                        <td class="center"></td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            {{-- FOOTER --}}
                            <div class="footer">
                                Dicetak pada: {{ $generated_at }} &nbsp;&mdash;&nbsp; Sistem Inventaris ATK
                                &nbsp;&mdash;&nbsp; Mahkamah Agung Republik Indonesia
                            </div>
