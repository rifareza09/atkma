    ...
    <div class="info-block">
        <table>
            ...
            <tr>
                <td>TOTAL RUANGAN</td>
                <td class="colon">:</td>
                <td class="val">{{ $ruangans->count() }} ruangan</td>
            </tr>
        </table>
    </div>
        ...
        <tbody>
            ...
            @foreach($ruangans as $ruanganData)
                ...
                <tr class="subtotal-row">
                    <td colspan="4" class="right">Subtotal {{ strtoupper($ruanganData['ruangan']) }}</td>
            ...
            <tr class="grand-total-row">
                <td colspan="4" class="center">TOTAL DISTRIBUSI — {{ strtoupper($month_name) }} {{ $year }}</td>
