                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        {barang_stok_rendah.map((barang) => {
                                            const selisih = barang.stok_minimum - barang.stok;
                                            return (
